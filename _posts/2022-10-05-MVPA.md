...
最后一步，怎么看group-level的结果？针对每个time point做1-sample t test，跟chance level比较。二分的话就是0.5了，Bae那篇是0.0625。推荐用cluster t test去做，我这里的code是2个分类的。
...
彩蛋就其实MNE有几个专门decoding的functions，所以我们其实可以直接用人家的code，不用在这搞人工智障了。同样within和cross的code我都放出来了：
