...
# data structure: 640 trials * 27 channels * 250 times
```

Bae这一篇是每个trial有250个time points，每个被试做了640个trials，decode 27个channels。Decoding可以ERP based也可以band power based。Bae两个都做了，我这里只展示ERP based，因为步骤都一样。

subjN = 30
for subj in range(1,subjN+1):
