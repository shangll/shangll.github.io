...
**Shang, L.\***, Yeh L.-C., Zhao, Y., & Peelen, M. V.\* (2026). Unpacking similarity effects in visual memory search: categorical, semantic, and visual contributions. *Journal of Memory and Language, 146*. [https://doi.org/10.1016/j.jml.2025.104712](https://doi.org/10.1016/j.jml.2025.104712)
